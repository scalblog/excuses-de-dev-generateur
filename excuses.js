function Excuse() {
	...
	var myHomework = ['projet', 'navigateur', 'travail', 'session', 'Excel', 'document', 'papier', 'contrat', 'tentative de connexion', 'blog', 'article', 'carte mémoire', 'aide en ligne', 'rêve d\'un monde meilleur', 'memento', 'compte-rendu', 'presentation', 'portfolio', 'commentaire'];
